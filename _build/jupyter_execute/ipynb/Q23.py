...
# 
# 
# Crie uma função que "decodifica" palavras escondidas no sistema original em palavras equivalentes em nossa língua (p.ex: `ʢʠʬʠ` => `cama`). Use-a para encontrar a palavra equivalente ao anagrama `ʨʭʣδʡʨγʠεʤʫʬʤʭγʤ` e assinale a alternativa correta.
# 
# A. inevitavelmente
# 
# B. indiscutivelmente
